...
export type VariableSpecResponse = {
    ...
    /**
     * For a connector account variable, which of the connector's kinds the source install used ('composio', 'http', 'mcp', 'sql'), so the importer selects an account of the same kind. Null for non-connector variables.
     */
