...
Scenario tests declaring a promise: 351.
...
| `PS-SURF-020` The answer comes back where the question was asked | `covered` | `test_a_real_message_reaches_a_real_person`, `test_an_unknown_sender_is_told_how_to_get_access` |
