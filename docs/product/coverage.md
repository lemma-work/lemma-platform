...
Scenario tests declaring a promise: 353.
...
| `PS-SURF-020` The answer comes back where the question was asked | `gap` | `test_a_real_message_reaches_a_real_person`, `test_a_message_is_answered`, `test_an_unknown_sender_is_told_how_to_get_access` |
