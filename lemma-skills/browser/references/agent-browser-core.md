...
<!-- Vendored verbatim from agent-browser 0.37.1 (`skill-data/core`), which
     is the version the workspace image installs. Do not edit this file: the
     last copy was hand-maintained and had drifted 31 lines from upstream.
     Anything true of *this* sandbox rather than of the CLI belongs in
     ../SKILL.md. Re-copy on an agent-browser bump. -->
