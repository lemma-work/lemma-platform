...
routing/components/state. A conversation **widget** uses the same browser runtime
as an HTML app and can be saved as one verbatim — see the `lemma-widget` skill.
