        ...
        <div className={cn('rounded-md bg-[var(--surface-1)] px-3 py-3', className)}>
            <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                    ...
                    {/*
                      * The agent's version and how many models it offers — the
                      * two things about a row that are the user's business.
                      *
                      * The adapter version led this line and is not: it is the
                      * ACP bridge Lemma pins and installs, so it is the same for
                      * everyone on a release and can only ever be a number they
                      * cannot act on. It was also the *only* thing an installing
                      * row could show, which is how a row mid-install came to
                      * read "adapter 0.62.0" over two identical sentences about
                      * installing. It is still in the log and the API for
                      * support; it is not a fact about their computer.
                      */}
