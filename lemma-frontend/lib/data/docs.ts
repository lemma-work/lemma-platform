    ...
    blocks: [
      {
        ...
        rows: [
          ['Pod-scoped', 'tables, records, files, functions, agents, conversations, workflows, apps, resources, schedules, datastore, notify'],
          ['Org and user', 'users, organizations, pods, podMembers, podJoinRequests, podSurfaces, userSurfaces, notifications, icons'],
