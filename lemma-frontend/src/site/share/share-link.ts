...
import type { SocialCardVariant } from "@/site/share/social-card";
...
const SHARE_KIND_COPY: Record<ShareKind, ShareKindCopy> = {
    ...
    contact: {
        noun: "Contact",
        article: "an agent you can message",
        variant: "contact",
    },
...
export function isShareKind(
    value: string | null | undefined,
): value is ShareKind {
    return SHARE_KINDS.includes(value as ShareKind);
}

export function shareKindForResourceType(
 ...
 */
export function resolveSharePodId(
    segments: string[] | undefined,
): string | null {
