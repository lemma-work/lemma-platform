import type { DocsPage } from "@/site/data/docs";
        ...
        blocks: [
            {
                ...
                body: "The most common failed first agent is a general assistant with access to everything and a vague brief. It demos well and then nobody trusts it with real work. The fix is to go narrow: one job, one table, one example you can check by hand.",
            },
            {
                type: "steps",
                title: "Build it",
            ...
            },
            {
                ...
                body: "Someone on your team sees the rows the agent wrote and cannot tell which were created by a person.",
            },
            {
                type: "list",
        ...
        blocks: [
            {
                ...
                body: "Every triage process is the same five steps: something arrives, judgment classifies it, rules score it, a record is filed, and a human catches the exceptions. That maps one-to-one onto Lemma: surface → agent → function → table → approval.",
            },
            {
                type: "steps",
                title: "Build it",
            ...
            },
            {
                ...
                body: "Wire the inbox trigger only after manual runs look right. A flow misfiling test data is a shrug; a flow misfiling a week of real customer email is a cleanup project.",
            },
        ],
    },
    {
        ...
        blocks: [
            ...
            },
            {
                ...
                body: "Connecting Slack as a surface lets work reach the pod. Connecting Slack as a connector lets agents and flows act on Slack — post to channels, read history — as a tool. Many pods use both.",
            },
        ],
    },
    {
        ...
        blocks: [
            {
                ...
                body: "Could two careful colleagues disagree about the right output? If yes, it is judgment — use an agent. If no — if there is one correct answer a rulebook produces — it is rules, and rules belong in a function, where the same input gives the same output every single time.",
            },
            {
                type: "table",
                ...
                rows: [
                    [
                        ...
                        "Agent",
                        "No single correct summary exists.",
                    ],
                    [
                        "Score a lead by employee count and region",
                        "Function",
                        "The rulebook is exact; disagreement means a bug.",
                    ],
                    [
                        "Decide if this email is a complaint",
                        "Agent",
                        "Language is ambiguous; judgment required.",
                    ],
                    [
                        "Validate an expense against policy limits",
                        "Function",
                        "Limits are numbers; the answer is yes or no.",
                    ],
                    [
                        "Draft the rejection message",
                        "Agent",
                        "Tone and content vary by case.",
                    ],
                    [
                        "Convert currency on the invoice",
                        "Function",
                        "Math. Always math.",
                    ],
                ],
            },
            {
                ...
                body: "Most good workflows sandwich them: an agent interprets the messy input, a function applies the exact rules to the agent’s structured output, and another agent drafts the human-facing result. Judgment at the edges, rules in the middle.",
            },
            {
                type: "callout",
                tone: "warning",
                title: "The smell to watch for",
                body: "If you find yourself writing agent instructions full of thresholds, point values, and if-then rules, stop — that paragraph wants to be a function. Agents drift; functions don’t.",
            },
        ],
    },
    {
            ...
            },
            {
                ...
                rows: [
                    [
                        "Private",
                        "Only you",
                        "Drafts, experiments, sensitive tables",
                    ],
                    [
                        "Pod",
                        "Members of this pod",
                        "The default for everything in active use",
                    ],
                    [
                        "Organization",
                        "Anyone in your org",
                        "Finished apps and shared reference data",
                    ],
                ],
            },
            {
                ...
                body: "Sharing and scopes control standing access. For one-off consequential actions — refunds, sends, deletes — use an approval step in the workflow so a named person decides each time.",
            },
        ],
    },
];
