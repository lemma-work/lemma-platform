import {
    ...
    glossaryStub,
    howLemmaWorksStub,
} from "@/site/data/concept-docs";
import { educationGuidePages } from "@/site/data/education-guides";
        ...
        blocks: [
            {
                ...
                body: "Use Lemma Cloud when you want a hosted workspace, Lemma Stack when you want the full product on your machine, or the source checkout when you are contributing to the platform.",
            },
            {
                type: "table",
                ...
                rows: [
                    [
                        "Lemma Cloud",
                        "You want to start without hosting anything.",
                        "An account at lemma.work and hosted pods.",
                    ],
                    [
                        "Local stack",
                        "You want the product running on your own machine.",
                        "Frontend, API, database, auth, Redis, and document processing in containers.",
                    ],
                    [
                        "Source checkout",
                        "You want to change Lemma itself.",
                        "Hot-reload backend and frontend from this repo.",
                    ],
                ],
            },
            {
                ...
                body: "Create an account at lemma.work, then install the CLI and log in. Browser login will finish account setup if needed.",
                language: "bash",
...
lemma auth login`,
            },
            {
                ...
                body: "Run the released stack on your machine, open the app at http://localhost:3711, create an account, then point the CLI at the local server.",
                language: "bash",
...
lemma auth login`,
            },
            {
                ...
                body: "A pod is the workspace boundary: tables, files, agents, workflows, permissions, apps, and surfaces for one team or process.",
                language: "bash",
...
lemma pod describe`,
            },
            {
                ...
                body: "Use the TypeScript SDK in frontend apps and the Python SDK in pod function code.",
                language: "bash",
...
uv pip install lemma-sdk`,
            },
            {
                ...
                body: "Point the client at a selected pod and start reading tables, running workflows, and chatting with agents.",
                language: "ts",
...
const runs = await client.workflows.list();`,
            },
            {
                ...
                body: "Inside a function, the SDK reads credentials from the pod environment automatically.",
                language: "python",
...
rows = pod.records.list("tickets", limit=10).to_dict()["items"]`,
            },
            {
                ...
                tone: "success",
                title: "You are ready",
                body: "You now have an account, a server selected, the CLI installed, a starter pod, and SDK access from TypeScript and Python.",
            },
            {
                type: "list",
                title: "Next steps",
        ...
        blocks: [
            {
                ...
                body: "A Lemma pod is a bounded operating system for one business use case. It owns the state, logic, automation, permissions, and operator surfaces for that use case. The goal is not to create a loose collection of AI helpers; the goal is to give a team a system that can run a repeatable operating loop.",
            },
            {
                type: "list",
            ...
            },
            {
                type: "callout",
                title: "Mental model",
                body: "Models provide intelligence. Lemma provides rails: state, permissions, connectors, deterministic tools, human review, auditability, and interfaces.",
            },
            {
                type: "table",
                ...
                rows: [
                    ...
                    [
                        "Validation, coordinated writes, external calls",
                        "Function",
                    ],
                    [
                        "Drafting, research, classification, extraction",
                        "Agent through task or conversation",
                    ],
                    [
                        "Stages, branching, waits, schedules, triggers",
                        "Workflow",
                    ],
                    [
                        "Primary user interaction is chat",
                        "Conversation / assistant surface",
                    ],
                    [
                        "People need queues, forms, detail views, and actions",
                        "App",
                    ],
...
lemma pod describe <pod-id>`,
            },
            {
                ...
                body: "Before wiring an app or workflow node, run the underlying function, inspect agent output, and verify table records with realistic sample data.",
            },
        ],
    },
    {
        ...
        blocks: [
            {
                type: "paragraph",
                title: "Pod",
                body: "A pod is the technical and operational boundary for one team or process. It contains the tables, files, agents, workflows, functions, permissions, apps, and surfaces that make that work one system.",
            },
            {
                type: "paragraph",
                title: "Operating job",
        ...
        blocks: [
            {
                ...
                rows: [
                    [
                        ...
                        "Unstructured documents or binary assets",
                    ],
                    [
                        "Record API",
                        "Simple table CRUD",
                        "Multi-table writes with business rules",
                    ],
                    [
                        "File",
                        "Documents and attachments",
                        "State that needs filtering, sorting, or workflow transitions",
                    ],
                    [
                        "Function",
                        "Typed deterministic logic",
                        "Single-row inserts with no business logic",
                    ],
                    [
                        "Agent",
                        "Judgment-heavy reasoning",
                        "Deterministic writes or hidden side effects",
                    ],
                    [
                        "Workflow",
                        "Orchestration over time",
                        "One-shot actions with no real process",
                    ],
                    [
                        "Conversation",
                        "Interactive or agent-scoped message flow",
                        "Durable business data",
                    ],
                    [
                        "App",
                        "Repeatable operator workflow",
                        "Static marketing or dashboard posters",
                    ],
                    [
                        "Connector",
                        "External system access",
                        "Pod-local business state",
                    ],
                ],
            },
            {
                type: "callout",
                title: "Build order",
                body: "For real pods, provision connectors, functions, workflows, and apps in that order. Apps are imagined early, but wired last against verified upstream resources.",
            },
        ],
    },
    {
        ...
        blocks: [
            {
                ...
                body: "If you have not already, install the Lemma CLI (lemma-terminal) to create pods, manage resources, and scaffold apps. See the Getting Started guide for the full setup.",
            },
            {
                type: "code",
            ...
            },
            {
                ...
                body: "The SDK resolves API/auth URLs from explicit overrides, window config, or environment variables. Defaults point at the hosted Lemma services.",
                language: "ts",
                code: `import { LemmaClient } from "lemma-sdk";
...
await client.initialize();`,
            },
            {
                ...
                rows: [
                    ...
                    [
                        "CRA / webpack",
                        "REACT_APP_LEMMA_API_URL, REACT_APP_LEMMA_AUTH_URL, REACT_APP_LEMMA_POD_ID",
                    ],
        ...
        blocks: [
            {
                ...
                rows: [
                    [
                        "Pod-scoped",
                        "tables, records, files, functions, agents, conversations, workflows, apps, resources, schedules, datastore",
                    ],
                    [
                        "Org and user",
                        "users, organizations, pods, podMembers, podJoinRequests, podSurfaces, icons",
                    ],
...
const currentUser = await podClient.users.current();`,
            },
            {
                type: "callout",
                title: "Escape hatch",
                body: "Use client.request<T>(method, path, options) only when a generated API exists but no typed namespace wrapper has landed yet.",
            },
        ],
    },
    {
        ...
        blocks: [
            {
                ...
                body: "Create a conversation first, then send messages with the returned conversation id. Do not use create-if-missing message helpers for new code.",
            },
            {
                type: "code",
  ...
  metadata: { ticket_id: "ticket_123" },
            ...
            },
            {
                ...
                rows: [
                    ...
                    [
                        "Stream messages and final output",
                        "useConversationMessages",
                    ],
                    [
                        "Build full assistant UI behavior",
                        "useAssistantController / useAssistantRuntime",
                    ],
        ...
        blocks: [
            {
                ...
                rows: [
                    ...
                    [
                        "Schema-driven forms",
                        "useRecordForm, useRecordSchema, useForeignKeyOptions",
                    ],
                    [
                        "Joins and related records",
                        "useJoinedRecords, useRelatedRecords, useReverseRelatedRecords",
                    ],
                    [
                        "Custom SQL reads and aggregates",
                        "useDatastoreQuery, useRecordAggregates",
                    ],
                ],
            },
            {
        ...
        blocks: [
            {
                ...
                rows: [
                    ...
                    [
                        "Show waits assigned to current pod member",
        ...
        blocks: [
            ...
            },
            {
                ...
                rows: [
                    [
                        "Records",
                        "lemma-records-view, lemma-detail-panel, lemma-record-form, lemma-status-flow",
                    ],
                    [
                        "Search and files",
                        "lemma-global-search, lemma-file-browser, lemma-document-workspace, lemma-markdown-editor, lemma-page-tree",
                    ],
                    [
                        "Collaboration",
                        "lemma-comments, lemma-activity-feed, lemma-insights, lemma-action-surface",
                    ],
                    [
                        "Workflow and shell",
                        "lemma-workflow-runner, lemma-members, lemma-notification-bell, lemma-user-menu",
                    ],
            ...
            },
            {
                ...
                body: "Use registry blocks when they fit the operator job. For custom review, triage, approval, or queue workflows, build the route locally and use hooks first.",
            },
        ],
    },
    {
        ...
        blocks: [
            ...
            },
            {
                ...
                rows: [
                    [
                        "auth, config, ls",
                        "Authentication, local config, org/pod tree snapshot",
                    ],
                    ["organization, pod", "Workspace and pod lifecycle"],
                    ["table, record, query, file", "Data and file management"],
                    [
                        "function, agent, task, assistant, conversation",
                        "AI and deterministic runtime resources",
                    ],
                    ["workflow", "Workflow definitions, installs, and runs"],
                    ["app", "App metadata, clone, and deploy"],
                    [
                        "connector",
                        "Connectors, operations, triggers, and connected accounts",
                    ],
                    [
                        "operation, web, tool",
                        "OpenAPI inspection, web tools, and agent tooling",
                    ],
                ],
            },
            {
...
lemma ls`,
            },
            {
                ...
                rows: [
                    ...
                    [
                        "--token",
                        "Bearer token, also read from LEMMA_TOKEN or config",
                    ],
                    [
                        "--config-file",
                        "Alternate config path, default ~/.lemma/config.json",
                    ],
                    ["--no-verify-ssl", "Local/self-signed development only"],
                    [
                        "--output json",
                        "Machine-readable output for scripts and artifacts",
                    ],
                ],
            },
            {
                ...
                body: "If https://api.localhost returns SSL or proxy failures in local backend work, use explicit 127.0.0.1 base URLs before assuming the CLI command is broken.",
            },
        ],
    },
    {
        ...
        blocks: [
            {
                ...
                rows: [
                    ...
                    [
                        "pod describe",
                        "Snapshot metadata, agents, assistants, functions, tables, workflows, and file roots",
                    ],
                    [
                        "pod member-list/member-add/member-update-role/member-remove",
                        "Pod roster operations",
                    ],
                    [
                        "pod export/import",
                        "Export or apply pod resource folder trees",
                    ],
                ],
            },
            {
...
lemma file search onboarding --pod-id <pod-id> --scope-path /manuals --scope-mode SUBTREE`,
            },
            {
                ...
                body: "Do not write user_id, created_at, or updated_at. For collaborative ownership, store explicit business fields and resolve people through pod member APIs.",
            },
        ],
    },
    {
...
lemma task get <task-id> --pod-id <pod-id>`,
            },
            {
                ...
                rows: [
                    ...
                    [
                        "External app operation with retries",
                        "Function plus accessible_connectors",
                    ],
                    [
                        "Research, summarization, extraction, classification",
                        "Agent",
                    ],
                    [
                        "Background agent execution",
                        "Task or workflow AGENT node",
                    ],
...
lemma workflow run-resume expense-review <run-id> --pod-id <pod-id> --payload-file ./payloads/resume.json`,
            },
            {
                ...
                body: "A manual workflow should usually have at least two substantive stages after intake, or a clear need for branching, waiting, looping, approval handoffs, or resumability.",
            },
        ],
    },
    {
  ...
  --payload-file ./payloads/messages-send.json`,
            },
            {
                ...
                rows: [
                    [
                        "DYNAMIC",
                        "The runtime should act through the current caller connected account.",
                    ],
                    [
                        "FIXED",
                        "The workload should always use a designated shared or service account.",
                    ],
                ],
            },
        ],
    },
    {
        ...
        blocks: [
            ...
            },
            {
                ...
                body: "The operator opens the app and immediately knows what needs attention, why it matters, and what action is safe to take next.",
            },
        ],
    },
    {
        ...
        blocks: [
            {
                ...
                rows: [
                    [
                        "pod",
                        "list, create, get, update, delete, config, describe, member-list, member-add, member-update-role, member-remove, export, import",
                    ],
                    [
                        "table",
                        "list, create, get, update, delete, describe, column-add, column-remove",
                    ],
                    [
                        "file",
                        "list, ls, describe, upload, download, search, get, update, delete, folder-create",
                    ],
                    [
                        "function",
                        "list, get, create, update, delete, run, run-list, run-get",
                    ],
                    ["agent", "list, get, create, update, delete"],
                    [
                        "workflow",
                        "list, get, create, graph-update, update, delete, install-create, install-list, install-delete, run-start, run-get, run-list, run-resume",
                    ],
                    ["app", "list, get, create, update, delete, deploy, clone"],
                    [
                        "conversation",
                        "list, create, get, message-send, message-list",
                    ],
                    [
                        "connector",
                        "list, get, operation-discover, operation-details, operation-execute, trigger list/get, account list, connect-request create",
                    ],
                ],
            },
        ],
...
export function getDocsPageFromSegments(
