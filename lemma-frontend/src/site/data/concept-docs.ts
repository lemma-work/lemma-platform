import {
    ...
    type ConceptEntry,
    type ConceptId,
} from "@/site/education/concepts";
import type { DocsBlock, DocsPage } from "@/site/data/docs";
...
const CONCEPT_DOCS_EXTRA: Record<ConceptId, ConceptDocsExtra> = {
    ...
    agent: {
        ...
        whereItLives:
            "Agents in the left sidebar. Each agent has Runs, Edit, and History tabs.",
    },
    flow: {
        useWhen: [
    ...
    file: {
        ...
        whereItLives:
            "Docs in the left sidebar. Personal files live under your own space; pod files are shared.",
    },
    surface: {
        useWhen: [
        ...
        whereItLives:
            "Surfaces in the left sidebar. Each card shows a surface, its status, and its routing.",
    },
    app: {
        useWhen: [
        ...
        whereItLives:
            "Apps in the left sidebar. Each app deploys at its own URL.",
    },
    kit: {
        useWhen: [
        ...
        whereItLives:
            "Kits in the left sidebar, and featured kits appear on the pod home.",
    },
    function: {
        useWhen: [
    ...
    schedule: {
        ...
        whereItLives:
            "Schedules in the left sidebar; upcoming runs also show on the pod home.",
    },
    connector: {
        useWhen: [
    ...
    grant: {
        ...
        whereItLives:
            "The Share button on every resource — agents, tables, apps, files.",
    },
    scope: {
        useWhen: [
    ...
    approval: {
        ...
        whereItLives:
            "Approval steps inside the workflow editor; pending ones reach the assignee directly.",
    },
    variable: {
        useWhen: [
