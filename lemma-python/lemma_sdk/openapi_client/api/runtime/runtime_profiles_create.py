...
from ...models.create_azure_open_ai_runtime_profile_request import (
    CreateAzureOpenAIRuntimeProfileRequest,
)
from ...models.create_google_vertex_runtime_profile_request import (
    CreateGoogleVertexRuntimeProfileRequest,
)
from ...models.create_harness_runtime_profile_request import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/organizations/{org_id}/runtime/profiles".format(
            org_id=quote(str(org_id), safe=""),
        ),
    }

    if isinstance(body, CreateOpenAICompatibleRuntimeProfileRequest):
        _kwargs["json"] = body.to_dict()
    elif isinstance(body, CreateAnthropicCompatibleRuntimeProfileRequest):
        _kwargs["json"] = body.to_dict()
    elif isinstance(body, CreateAzureOpenAIRuntimeProfileRequest):
        _kwargs["json"] = body.to_dict()
    elif isinstance(body, CreateGoogleVertexRuntimeProfileRequest):
        _kwargs["json"] = body.to_dict()
    else:
        _kwargs["json"] = body.to_dict()
        ...
        def _parse_response_201(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_201_type_0 = OpenAICompatibleRuntimeProfileResponse.from_dict(
                    data
                )
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_201_type_2 = AzureOpenAIRuntimeProfileResponse.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_201_type_3 = GoogleVertexRuntimeProfileResponse.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            response_201_type_4 = HarnessRuntimeProfileResponse.from_dict(data)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        org_id (UUID):
        body (CreateAnthropicCompatibleRuntimeProfileRequest |
            CreateAzureOpenAIRuntimeProfileRequest | CreateGoogleVertexRuntimeProfileRequest |
            CreateHarnessRuntimeProfileRequest | CreateOpenAICompatibleRuntimeProfileRequest):
