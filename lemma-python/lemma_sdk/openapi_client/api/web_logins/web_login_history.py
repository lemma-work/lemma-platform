...
from ...models.web_login_audit_response import WebLoginAuditResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = WebLoginAuditResponse.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | WebLoginAuditResponse
    """
