...
def sync_detailed(
    *,
    ...
    """Get Installation
     ...
     What kind of installation this is, whether the current user owns it, and who may sign up. On a
    Desktop installation the owner is the first account created, and is the only user granted host-level
    capabilities.
