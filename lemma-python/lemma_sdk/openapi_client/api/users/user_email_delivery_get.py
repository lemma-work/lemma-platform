...
from ...models.email_delivery_status_response import EmailDeliveryStatusResponse
...
) -> EmailDeliveryStatusResponse | None:
    if response.status_code == 200:
        response_200 = EmailDeliveryStatusResponse.from_dict(response.json())
