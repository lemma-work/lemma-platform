...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/pods/{pod_id}/datastore/files/by-path/retry-processing".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Retry File Processing
     ...
     Queue a document whose processing failed to be read and indexed again, with a fresh retry budget. A
    file that did not fail is returned unchanged.
