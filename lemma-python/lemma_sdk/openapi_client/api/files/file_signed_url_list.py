...
from ...models.signed_url_list_response import SignedUrlListResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/pods/{pod_id}/datastore/files/signed-urls".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SignedUrlListResponse.from_dict(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        ErrorResponse | SignedUrlListResponse
    """
