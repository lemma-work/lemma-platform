...
T = TypeVar("T", bound="AgentHostIntegrationCapabilities")


@_attrs_define
class AgentHostIntegrationCapabilities:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_host_integration_capabilities = cls(
        ...
        agent_host_integration_capabilities.additional_properties = d
        return agent_host_integration_capabilities
