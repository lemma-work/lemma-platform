...
if TYPE_CHECKING:
    from ..models.agent_host_integration_response_capabilities import (
        AgentHostIntegrationResponseCapabilities,
    )
    from ..models.agent_host_integration_response_metadata import (
        AgentHostIntegrationResponseMetadata,
    )


T = TypeVar("T", bound="AgentHostIntegrationResponse")


@_attrs_define
class AgentHostIntegrationResponse:
    """
    Attributes:
        adapter_protocol (str):
        adapter_version (str):
        auth_state (str):
        capabilities (AgentHostIntegrationResponseCapabilities):
        ...
        id (UUID):
        integration_key (str):
        metadata (AgentHostIntegrationResponseMetadata):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        capabilities = AgentHostIntegrationResponseCapabilities.from_dict(
            d.pop("capabilities")
        )
        ...
        metadata = AgentHostIntegrationResponseMetadata.from_dict(d.pop("metadata"))
        ...
        agent_host_integration_response = cls(
            adapter_protocol=adapter_protocol,
            adapter_version=adapter_version,
            auth_state=auth_state,
            capabilities=capabilities,
        ...
        agent_host_integration_response.additional_properties = d
        return agent_host_integration_response
