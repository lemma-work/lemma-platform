...
if TYPE_CHECKING:
    from ..models.google_vertex_runtime_config import GoogleVertexRuntimeConfig
    from ..models.runtime_model_catalog_entry import RuntimeModelCatalogEntry


T = TypeVar("T", bound="GoogleVertexRuntimeProfileResponse")


@_attrs_define
class GoogleVertexRuntimeProfileResponse:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.config, GoogleVertexRuntimeConfig):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_config(data: object) -> GoogleVertexRuntimeConfig | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                config_type_0 = GoogleVertexRuntimeConfig.from_dict(data)

                return config_type_0
            except TypeError, ValueError, AttributeError, KeyError:
                pass
            return cast(GoogleVertexRuntimeConfig | None, data)
        ...
        google_vertex_runtime_profile_response = cls(
            config=config,
            id=id,
            name=name,
            runtime_type=runtime_type,
        ...
        google_vertex_runtime_profile_response.additional_properties = d
        return google_vertex_runtime_profile_response
