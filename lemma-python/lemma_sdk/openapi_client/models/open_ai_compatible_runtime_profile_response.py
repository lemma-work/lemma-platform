...
if TYPE_CHECKING:
    from ..models.open_ai_compatible_runtime_config import OpenAICompatibleRuntimeConfig
    from ..models.runtime_model_catalog_entry import RuntimeModelCatalogEntry


T = TypeVar("T", bound="OpenAICompatibleRuntimeProfileResponse")


@_attrs_define
class OpenAICompatibleRuntimeProfileResponse:
    """
    Attributes:
        config (None | OpenAICompatibleRuntimeConfig):
        id (str):
        name (str):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.open_ai_compatible_runtime_config import (
            OpenAICompatibleRuntimeConfig,
        )

        config: dict[str, Any] | None
        if isinstance(self.config, OpenAICompatibleRuntimeConfig):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_config(data: object) -> None | OpenAICompatibleRuntimeConfig:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                config_type_0 = OpenAICompatibleRuntimeConfig.from_dict(data)

                return config_type_0
            except TypeError, ValueError, AttributeError, KeyError:
                pass
            return cast(None | OpenAICompatibleRuntimeConfig, data)
        ...
        open_ai_compatible_runtime_profile_response = cls(
            config=config,
            id=id,
            name=name,
            runtime_type=runtime_type,
        ...
        open_ai_compatible_runtime_profile_response.additional_properties = d
        return open_ai_compatible_runtime_profile_response
