...
T = TypeVar("T", bound="DataStoreWorkflowStartConfigInput")


@_attrs_define
class DataStoreWorkflowStartConfigInput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data_store_workflow_start_config_input = cls(
            table_name=table_name,
            operations=operations,
        )

        data_store_workflow_start_config_input.additional_properties = d
        return data_store_workflow_start_config_input
