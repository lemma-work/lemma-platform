...
if TYPE_CHECKING:
    from ..models.anthropic_compatible_runtime_config import (
        AnthropicCompatibleRuntimeConfig,
    )
    from ..models.runtime_model_catalog_entry import RuntimeModelCatalogEntry


T = TypeVar("T", bound="AnthropicCompatibleRuntimeProfileResponse")


@_attrs_define
class AnthropicCompatibleRuntimeProfileResponse:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.config, AnthropicCompatibleRuntimeConfig):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_config(data: object) -> AnthropicCompatibleRuntimeConfig | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                config_type_0 = AnthropicCompatibleRuntimeConfig.from_dict(data)

                return config_type_0
            except TypeError, ValueError, AttributeError, KeyError:
                pass
            return cast(AnthropicCompatibleRuntimeConfig | None, data)
        ...
        anthropic_compatible_runtime_profile_response = cls(
            config=config,
            id=id,
            name=name,
            runtime_type=runtime_type,
        ...
        anthropic_compatible_runtime_profile_response.additional_properties = d
        return anthropic_compatible_runtime_profile_response
