...
T = TypeVar("T", bound="OauthCredentialsResponseSchema")


@_attrs_define
class OauthCredentialsResponseSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        oauth_credentials_response_schema.additional_properties = d
        return oauth_credentials_response_schema
