...
if TYPE_CHECKING:
    from ..models.harness_runtime_config import HarnessRuntimeConfig
    from ..models.runtime_model_catalog_entry import RuntimeModelCatalogEntry


T = TypeVar("T", bound="HarnessRuntimeProfileResponse")


@_attrs_define
class HarnessRuntimeProfileResponse:
    """
    Attributes:
        ...
        harness_config_revision (None | str | Unset):
        harness_health (None | str | Unset):
        harness_key (None | str | Unset):
    ...
    harness_config_revision: None | str | Unset = UNSET
    harness_health: None | str | Unset = UNSET
    harness_key: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        harness_config_revision: None | str | Unset
        if isinstance(self.harness_config_revision, Unset):
            harness_config_revision = UNSET
        else:
            harness_config_revision = self.harness_config_revision

        harness_health: None | str | Unset
        if isinstance(self.harness_health, Unset):
            harness_health = UNSET
        else:
            harness_health = self.harness_health

        harness_key: None | str | Unset
        if isinstance(self.harness_key, Unset):
            harness_key = UNSET
        else:
        ...
        if harness_config_revision is not UNSET:
            field_dict["harness_config_revision"] = harness_config_revision
        if harness_health is not UNSET:
            field_dict["harness_health"] = harness_health
        if harness_key is not UNSET:
            field_dict["harness_key"] = harness_key
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        config = HarnessRuntimeConfig.from_dict(d.pop("config"))
        ...
        def _parse_harness_config_revision(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        harness_config_revision = _parse_harness_config_revision(
            d.pop("harness_config_revision", UNSET)
        )

        def _parse_harness_health(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        harness_health = _parse_harness_health(d.pop("harness_health", UNSET))

        def _parse_harness_key(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        harness_key = _parse_harness_key(d.pop("harness_key", UNSET))
        ...
        harness_runtime_profile_response = cls(
            config=config,
            harness_id=harness_id,
            id=id,
            name=name,
            ...
            harness_config_revision=harness_config_revision,
        ...
        harness_runtime_profile_response.additional_properties = d
        return harness_runtime_profile_response
