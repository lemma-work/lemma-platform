...
T = TypeVar("T", bound="DisplaySizeRequest")


@_attrs_define
class DisplaySizeRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        display_size_request = cls(
            height=height,
            width=width,
        )

        display_size_request.additional_properties = d
        return display_size_request
