...
if TYPE_CHECKING:
    from ..models.event_workflow_start_config_output_trigger_config import (
        EventWorkflowStartConfigOutputTriggerConfig,
    )


T = TypeVar("T", bound="EventWorkflowStartConfigOutput")


@_attrs_define
class EventWorkflowStartConfigOutput:
    """
    Attributes:
        connector_id (str): Connector connector identifier.
        connector_trigger_id (str): Connector trigger identifier to subscribe to.
        trigger_config (EventWorkflowStartConfigOutputTriggerConfig | Unset):
    """

    connector_id: str
    connector_trigger_id: str
    trigger_config: EventWorkflowStartConfigOutputTriggerConfig | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_trigger_config, Unset):
            ...
            trigger_config = EventWorkflowStartConfigOutputTriggerConfig.from_dict(
                _trigger_config
            )

        event_workflow_start_config_output = cls(
            connector_id=connector_id,
            connector_trigger_id=connector_trigger_id,
            trigger_config=trigger_config,
        )

        event_workflow_start_config_output.additional_properties = d
        return event_workflow_start_config_output
