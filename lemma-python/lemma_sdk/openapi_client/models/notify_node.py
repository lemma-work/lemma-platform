...
if TYPE_CHECKING:
    ...
    from ..models.notify_node_position_type_0 import NotifyNodePositionType0


T = TypeVar("T", bound="NotifyNode")
...
class NotifyNode:
    ...
    their Lemma inbox, then advances — it does not wait for a reply.
        ...
        Attributes:
            ...
            position (None | NotifyNodePositionType0 | Unset):
    ...
    position: None | NotifyNodePositionType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.position, Unset):
            position = UNSET
        elif isinstance(self.position, NotifyNodePositionType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_position(data: object) -> None | NotifyNodePositionType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                position_type_0 = NotifyNodePositionType0.from_dict(data)

                return position_type_0
            except TypeError, ValueError, AttributeError, KeyError:
                pass
            return cast(None | NotifyNodePositionType0 | Unset, data)
        ...
        notify_node.additional_properties = d
        return notify_node
