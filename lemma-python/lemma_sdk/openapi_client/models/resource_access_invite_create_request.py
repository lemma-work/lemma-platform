...
T = TypeVar("T", bound="ResourceAccessInviteCreateRequest")


@_attrs_define
class ResourceAccessInviteCreateRequest:
    """
    Attributes:
        email (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource_access_invite_create_request = cls(
            email=email,
            resource_type=resource_type,
        ...
        resource_access_invite_create_request.additional_properties = d
        return resource_access_invite_create_request
