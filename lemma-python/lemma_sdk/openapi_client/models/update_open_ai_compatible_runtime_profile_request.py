...
if TYPE_CHECKING:
    from ..models.update_open_ai_compatible_runtime_profile_request_model_settings_type_0 import (
        UpdateOpenAICompatibleRuntimeProfileRequestModelSettingsType0,
    )


T = TypeVar("T", bound="UpdateOpenAICompatibleRuntimeProfileRequest")


@_attrs_define
class UpdateOpenAICompatibleRuntimeProfileRequest:
    """
    Attributes:
        ...
        model_settings (None | Unset | UpdateOpenAICompatibleRuntimeProfileRequestModelSettingsType0):
        name (None | str | Unset):
    ...
    model_settings: (
        None | Unset | UpdateOpenAICompatibleRuntimeProfileRequestModelSettingsType0
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_model_settings(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                model_settings_type_0 = UpdateOpenAICompatibleRuntimeProfileRequestModelSettingsType0.from_dict(
                    data
                )
        ...
        update_open_ai_compatible_runtime_profile_request = cls(
            api_key=api_key,
            base_url=base_url,
        ...
        update_open_ai_compatible_runtime_profile_request.additional_properties = d
        return update_open_ai_compatible_runtime_profile_request
