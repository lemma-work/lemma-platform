...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    "analytics.contract.violation": EventSpec(
        "warning", frozenset({"reason", "analytic_event", "origin"})
    ),
    ...
    'apps.tasks.sweep_app_releases.observed': EventSpec('info', frozenset({'pruned_app_count'})),
    ...
    'function.handlers.sweep_function_revisions.observed': EventSpec('info', frozenset({'pruned_function_count'})),
