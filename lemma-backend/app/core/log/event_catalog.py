...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'schedule.webhook_controller.source_observation_failed.degraded': EventSpec('warning', frozenset({'source'})),
    ...
    'schedule.webhook_sources.composio.verification_failed.diagnostic': EventSpec('debug', frozenset({'error_type'})),
