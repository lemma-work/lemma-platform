...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'agent.sign_in.capture_on_resume_failed': EventSpec('error', frozenset({'conversation_id', 'origin'})),
    ...
    'workspace.runtime_bundle.archive_missing': EventSpec('warning', frozenset({'archive', 'directory'})),
    'workspace.runtime_bundle.install_failed.degraded': EventSpec('warning', frozenset({'error_type', 'user_id', 'version'})),
    'workspace.runtime_bundle.installed': EventSpec('info', frozenset({'user_id', 'version'})),
    'workspace.runtime_bundle.loaded': EventSpec('info', frozenset({'size_bytes', 'source', 'version'})),
