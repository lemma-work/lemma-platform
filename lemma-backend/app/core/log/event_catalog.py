...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'agent_surfaces.agent_email_surface.provision_failed.degraded': EventSpec('warning', frozenset({'error', 'pod_id'})),
    'agent_surfaces.agent_email_surface.address_unavailable.degraded': EventSpec('warning', frozenset({'pod_id'})),
    'agent_surfaces.notification_service.auto_provision_failed.degraded': EventSpec('warning', frozenset({'error', 'pod_id'})),
