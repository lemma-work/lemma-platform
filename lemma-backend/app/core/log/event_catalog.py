...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'observability.telemetry.provider_flush_failed.degraded': EventSpec('warning', frozenset({'provider_type'})),
    'observability.telemetry.provider_shutdown_failed.degraded': EventSpec('warning', frozenset({'provider_type'})),
