...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'agent_surfaces.egress.skipped_missing_last.diagnostic': EventSpec('debug', frozenset({'conversation_id'})),
    'agent_surfaces.egress.skipped_no_adapter.diagnostic': EventSpec('debug', frozenset({'conversation_id', 'surface_type'})),
