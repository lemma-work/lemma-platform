...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'redis.stream.over_budget.degraded': EventSpec('warning', frozenset({'budget_bytes', 'memory_bytes', 'reason', 'stream'})),
    ...
    'redis.stream.trim_degraded.degraded': EventSpec('warning', frozenset({'group', 'hard_maxlen', 'maxlen', 'reason', 'stream'})),
    ...
    'web_login.totp_seed_unusable.degraded': EventSpec('warning', frozenset()),
    ...
    'workspace.browser_stream.relay_absent.degraded': EventSpec('warning', frozenset()),
    'workspace.browser_stream.session_unreadable.degraded': EventSpec('warning', frozenset()),
    'workspace.browser_stream.upstream.degraded': EventSpec('warning', frozenset()),
    'workspace.browser_stream.user_id_unparsable.degraded': EventSpec('warning', frozenset()),
    ...
    'workspace.takeover.capture_failed.degraded': EventSpec('warning', frozenset()),
}
