...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'agent_surfaces.notification_service.link_repoint_lost_race.observed': EventSpec('info', frozenset({'link_id', 'notification_id'})),
    ...
    'schedule.runs.recovered': EventSpec('warning', frozenset({'redelivered', 'reconciled', 'dead_lettered'})),
    ...
    'function.function_dispatcher.execution_failed': EventSpec('warning', frozenset({'run_id', 'error_type'})),
    'workspace.mime_type.unknown': EventSpec('debug', frozenset()),
    'workspace.sandbox_service.ensure_retrying': EventSpec('info', frozenset({'sandbox_id', 'attempt'})),
    ...
    'workspace.sandbox_sweeper.idle_release_failed': EventSpec('warning', frozenset({'sandbox_id', 'error_type'})),
    'workspace.sandbox_sweeper.orphan_destroy_failed': EventSpec('warning', frozenset({'sandbox_id', 'error_type'})),
    'workspace.sandbox_sweeper.orphan_reclaimed': EventSpec('info', frozenset({'sandbox_id', 'reason'})),
