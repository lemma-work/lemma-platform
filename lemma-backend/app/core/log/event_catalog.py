...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'usage.request_accounting_gateway.request_not_priceable.degraded': EventSpec('warning', frozenset({'model', 'provider', 'rate_card_enforceable', 'request_shape_priceable'})),
