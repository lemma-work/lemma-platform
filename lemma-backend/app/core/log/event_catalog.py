...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'agent_surfaces.notification_service.chat_delivery_failed.diagnostic': EventSpec('debug', frozenset({'reach_kind'})),
    'agent_surfaces.notification_service.conversation_hint_rejected.diagnostic': EventSpec('debug', frozenset({'conversation_id'})),
    'agent_surfaces.notification_service.notify_refused_no_membership_port.diagnostic': EventSpec('debug', frozenset()),
    'agent_surfaces.notification_service.notify_refused_not_a_member.diagnostic': EventSpec('debug', frozenset({'pod_id'})),
    'agent_surfaces.notification_service.open_conversation_failed.diagnostic': EventSpec('debug', frozenset({'pod_id'})),
    'agent_surfaces.notification_service.persist_message_failed.diagnostic': EventSpec('debug', frozenset({'conversation_id'})),
    'agent_surfaces.notification_service.repoint_failed.diagnostic': EventSpec('debug', frozenset()),
