...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'agent_surfaces.surface_routing.several_surfaces_share_one_bot.degraded': EventSpec('warning', frozenset({'answered_by', 'external_workspace_id', 'platform', 'surface_identity_id', 'surface_ids'})),
