...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'agent.handlers.cleanup_agent_host_retained_state.completed': EventSpec('info', frozenset({'pairings', 'events', 'commands', 'leases'})),
    'agent.infrastructure.agent_host_channels.publish_skipped': EventSpec('debug', frozenset({'channel'})),
    'agent.infrastructure.harnesses.agent_host.event_cleanup_failed': EventSpec('debug', frozenset({'agent_run_id'})),
    'agent.handlers.cleanup_agent_host_retained_state.failed': EventSpec('error', frozenset()),
    ...
    'agent.runtime_default.profile_missing': EventSpec('warning', frozenset({'profile_id', 'config_path'})),
