...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'function.execution.cancelled': EventSpec('info', frozenset({'cold', 'duration_ms', 'error_code', 'error_stack_hash', 'error_type', 'execution_mode', 'finalization_ms', 'function_id', 'operation_name', 'outcome', 'queue_wait_ms', 'run_id', 'runtime_call_ms', 'runtime_profile', 'sandbox_start_ms'})),
    'function.execution.completed': EventSpec('info', frozenset({'cold', 'duration_ms', 'error_code', 'error_stack_hash', 'error_type', 'execution_mode', 'finalization_ms', 'function_id', 'operation_name', 'outcome', 'queue_wait_ms', 'run_id', 'runtime_call_ms', 'runtime_profile', 'sandbox_start_ms'})),
    'function.execution.failed': EventSpec('error', frozenset({'cold', 'duration_ms', 'error_code', 'error_stack_hash', 'error_type', 'execution_mode', 'finalization_ms', 'function_id', 'operation_name', 'outcome', 'queue_wait_ms', 'run_id', 'runtime_call_ms', 'runtime_profile', 'sandbox_start_ms'})),
    'function.execution.rejected': EventSpec('warning', frozenset({'cold', 'duration_ms', 'error_code', 'error_stack_hash', 'error_type', 'execution_mode', 'finalization_ms', 'function_id', 'operation_name', 'outcome', 'queue_wait_ms', 'run_id', 'runtime_call_ms', 'runtime_profile', 'sandbox_start_ms'})),
    'function.execution.timed_out': EventSpec('warning', frozenset({'cold', 'duration_ms', 'error_code', 'error_stack_hash', 'error_type', 'execution_mode', 'finalization_ms', 'function_id', 'operation_name', 'outcome', 'queue_wait_ms', 'run_id', 'runtime_call_ms', 'runtime_profile', 'sandbox_start_ms'})),
