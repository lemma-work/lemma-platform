...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'function.execution.diagnostics.dispatch': EventSpec('warning', frozenset({'endpoint_ms', 'outcome', 'resolve_ms', 'run_id', 'runtime_call_ms', 'total_ms'})),
    'function.execution.diagnostics.runtime': EventSpec('warning', frozenset({'artifact_cache_hit', 'measured_user_code_ms', 'queued_to_claim_ms', 'run_id', 'run_to_terminal_ms', 'runtime_artifact_ms', 'runtime_claim_ms', 'runtime_total_ms', 'runtime_worker_ms'})),
