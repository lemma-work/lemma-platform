...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'agent.pydantic_ai.model_request_status_model.failed': EventSpec('error', frozenset({'status_code', 'model_name', 'agent_run_id', 'provider_error_kind', 'provider_error_code'})),
    'agent.history.token_ceiling_enforced.degraded': EventSpec('warning', frozenset({'size_before', 'size_after', 'dropped_count'})),
    'agent.pydantic_ai.model_stream_retry.degraded': EventSpec('warning', frozenset({'attempt', 'max_attempts', 'error_type'})),
    ...
    'agent.pydantic_ai_compat.unsupported_major_version.degraded': EventSpec('warning', frozenset({'installed_version', 'supported_major'})),
    ...
    'agent.web_fetch.session_failed.diagnostic': EventSpec('debug', frozenset()),
    ...
    'agent_surfaces.ingress_service.inbound_enrichment_failed.degraded': EventSpec('warning', frozenset({'surface_type'})),
    ...
    'infrastructure.streaq_runtime.worker_concurrency_exceeds_safe_db.degraded': EventSpec('warning', frozenset({'configured_concurrency', 'pool_capacity', 'safe_concurrency'})),
    ...
    'schedule.scheduler_controller.internal_token_missing.degraded': EventSpec('error', frozenset()),
