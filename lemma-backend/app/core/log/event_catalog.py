...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'authorization.cache.role_snapshot_cache_invalidation_stale.diagnostic': EventSpec('debug', frozenset()),
    'authorization.cache.role_snapshot_cache_read_re.diagnostic': EventSpec('debug', frozenset()),
    'authorization.cache.role_snapshot_cache_write.diagnostic': EventSpec('debug', frozenset()),
