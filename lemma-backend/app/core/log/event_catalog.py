...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'agent.web_fetch.batch_deadline_reached.degraded': EventSpec('warning', frozenset({'requested', 'captured'})),
    ...
    'infrastructure.streaq_runtime.pending_task_dump.diagnostic': EventSpec('warning', frozenset({'task_name', 'frames'})),
