...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'agent.handlers.interrupted_runs_resumed.observed': EventSpec('info', frozenset({'exhausted_count', 'resumed_count'})),
    ...
    'agent.handlers.resume_enqueue_failed.degraded': EventSpec('warning', frozenset({'agent_run_id'})),
    'agent.handlers.resume_interrupted_agent_runs_cron.failed': EventSpec('error', frozenset()),
    'agent.handlers.stranded_conversations_reconciled.degraded': EventSpec('warning', frozenset({'count'})),
    ...
    'agent_surfaces.ingress_service.surface_ask_user_native_render.degraded': EventSpec('warning', frozenset({'conversation_id'})),
    ...
    'agent_surfaces.ingress_service.surface_ask_user_text_fallback.failed': EventSpec('error', frozenset({'conversation_id'})),
    ...
    'agent_surfaces.ingress_service.surface_request_approval_native_render.degraded': EventSpec('warning', frozenset({'conversation_id'})),
    ...
    'agent_surfaces.ingress_service.surface_request_approval_text_fallback.failed': EventSpec('error', frozenset({'conversation_id'})),
