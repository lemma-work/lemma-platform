...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'function.dispatcher.process_termination.failed': EventSpec('warning', frozenset({'attempt_id', 'run_id'})),
    'function.dispatcher.ticket_delivery.unknown': EventSpec('warning', frozenset({'attempt_id', 'run_id'})),
