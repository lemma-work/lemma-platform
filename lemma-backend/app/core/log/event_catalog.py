...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'workspace.browser_relay.clear_failed.degraded': EventSpec('warning', frozenset()),
    ...
    'workspace.browser_view.relay_absent.degraded': EventSpec('warning', frozenset()),
    'workspace.browser_view.unsupported.denied': EventSpec('warning', frozenset()),
    'workspace.browser_view.upstream.degraded': EventSpec('warning', frozenset()),
