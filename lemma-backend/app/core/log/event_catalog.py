...
EVENT_CATALOG: dict[str, EventSpec] = {
    ...
    'agent_surfaces.email_surface_provisioning.failed.degraded': EventSpec('warning', frozenset({'agent_id', 'error', 'pod_id'})),
    'agent_surfaces.email_surface_provisioning.address_unavailable.degraded': EventSpec('warning', frozenset({'agent_id', 'pod_id'})),
    'agent_surfaces.notification_channels.provision_failed.degraded': EventSpec('warning', frozenset({'error', 'pod_id'})),
