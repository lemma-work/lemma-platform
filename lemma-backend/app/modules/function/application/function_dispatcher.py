...
class FunctionDispatcher:
    ...
    async def _invoke_runtime_with_recovery(
        ...
        *,
        ...
        # A trusted AgentBox 404/410 is generated by the allocation-bound proxy
        # before the runtime receives the invocation. Refreshing that stale grant
        # once is therefore safe. Transport errors and runtime 5xx responses may
        # arrive after user code started and must never be replayed here.
        try:
