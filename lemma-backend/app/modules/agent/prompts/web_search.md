...
`formats=["markdown", "jpeg"]` and inspect with `view_image`, or request PDF and use
`pod_view_document_pages`. JavaScript-heavy pages are retried in a browser;
`render=True` forces it. Upload durable research to the appropriate pod folder.
