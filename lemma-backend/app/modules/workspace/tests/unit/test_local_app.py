...
os.environ.setdefault("WORKSPACE_IMAGE", "workspace:test")
os.environ.setdefault("FUNCTION_IMAGE", "function:test")
...
def test_local_app_embeds_no_lemma_application() -> None:
    """The sandbox manager used to be mounted here and dialled over loopback.
    ...
    assert not [
        ...
        if isinstance(route, Mount) and "sandbox" in route.path
    ]
